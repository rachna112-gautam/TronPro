      ...
      <div className="container">
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-5 box" data-aos="fade-left">
            ...
            <button
              type="button"
              className="btn btn-primary m-2 copybtn"
