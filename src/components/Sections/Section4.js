        ...
        return(
           <section>
                ...
                <hr/>
                    ...
                    <li>Huge Airdrop of XPRO Taken</li>
                    ...
                    <div className="col-lg-6">
                      ...
                      <li>No presale</li>
                      <li>No Public Sale</li>
                      <li>No Team Token</li>
                      <li>Staking Rewards</li>
                      <li>Liquidity Pool Rewards</li>
                      <li>Yield Farming Rewards</li>
                      <li>Invest minimum 3000 trx get XPRO airdrop</li>
                   
                      </ul>
                      <div style={{"marginLeft":"-1rem"}}>
                      <strong>The More Contract Balance The Less XPRO Token Created
                      </strong>
                      </div>
                      </div>
                    ...
                    <div style={{"marginLeft":"-1rem"}}>
                    <strong>
                    <span style={{"color": "#f29412"}}>Total return limited to 300%</span><br/>
